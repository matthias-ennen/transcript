...
enum class AiModel(
    ...
    QUICK(
        ...
        downloadUrl = "https://huggingface.co/ggml-org/Qwen3.5-0.8B-GGUF/resolve/main/" +
    ...
    BALANCED(
        ...
        downloadUrl = "https://huggingface.co/unsloth/Qwen3.5-2B-GGUF/resolve/main/" +
    ...
    PRECISE(
        ...
        downloadUrl = "https://huggingface.co/unsloth/Qwen3.5-4B-GGUF/resolve/main/" +
